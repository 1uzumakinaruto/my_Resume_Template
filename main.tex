...
\resumeItemListStart
    ...
    \begin{itemize}
        ...
        \item\normalsize{ A web-based food delivery service connecting users with local restaurants.}
        \item\normalsize{ Features a user-friendly interface, customizable meal options, and real-time tracking.}
        \item\normalsize{ Secure payments, personalized recommendations, and exclusive deals.}
    ...
    \begin{itemize}
        ...
        \item\normalsize{ Web application mimicking the functionality of Google Gemini.}
        \item\normalsize{ Utilized Google Gemini API to create a streamlined search experience.}
        \item\normalsize{ Built with React.js for a responsive and interactive interface.}
    ...
    \textcolor{black}{-\small Front-End Web Development (React.js, Bootstrap, JavaScript)}}
    \hspace{5pt} \href{https://mytextutilizations.netlify.app/}{\color{blue}\underline{Try it!}}} 
    \vspace{-5pt}
    \begin{itemize}
        \setlength{\itemsep}{0pt}
        \setlength{\parskip}{0pt}
        \item\normalsize{ Web application for simplifying text manipulation tasks.}
        \item\normalsize{ Features text conversion (uppercase/lowercase), clearing, and copying functionalities.}
        \item \normalsize{User-friendly interface for streamlined text editing.}
